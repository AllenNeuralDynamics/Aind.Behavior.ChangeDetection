...
import aind_behavior_change_detection

SOURCE_ROOT = "https://github.com/AllenNeuralDynamics/Aind.Behavior.ChangeDetection/tree/main/src/DataSchemas/"

# -- Project information -----------------------------------------------------
# https://www.sphinx-doc.org/en/master/usage/configuration.html#project-information

project = "AIND Change Detection task"
copyright = "2024, Allen Institute for Neural Dynamics"
author = "Bruno Cruz"
release = aind_behavior_change_detection.__version__
...
html_title = "Aind Change Detection Task"
...
export_model_diagram(aind_behavior_change_detection.task_logic.AindChangeDetectionTaskLogic, _diagram_root)
